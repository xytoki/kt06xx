...
uchar xdata Dot	= 1<<2,K4 = 0<<2,AF_S14= 0<<3,AF_S13 = 0<<2,AF = 0<<3,MHz = 1<<3;
...
void RF_Power(uchar cPower_Level)
{
	switch(cPower_Level)
	{
		case 0:{ RF	= 0<<3;	RF_S1 =	0<<2;	RF_S2 =	0<<3;	RF_S3 =	0<<3;	RF_S4 = 0<<3;	RF_S5 =	0<<3;	RF_S6 =	0<<2;	RF_S7 =	0<<3; }break;
		case 1:{ RF	= 1<<3;	RF_S1 =	0<<2;	RF_S2 =	0<<3;	RF_S3 =	0<<3;	RF_S4 = 0<<3;	RF_S5 =	0<<3;	RF_S6 =	0<<2;	RF_S7 =	0<<3; }break;
	...
	else if(cAddress == 5)
	{
		for(i=0;i<4;i++)
		{
			if(i == 2)
				...
				Write_1621(cAddress*4+i,FREQ_NUM[cNum*4+i] | AF);
			else
				Write_1621(cAddress*4+i,FREQ_NUM[cNum*4+i]);
		}
	}
